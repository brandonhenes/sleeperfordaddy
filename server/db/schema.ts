...
export const prospectProfiles = pgTable("prospect_profiles", {
  ...
  keyConcerns: text("key_concerns").array(),
  ...
  combine40: numeric("combine_40"),
  combineVertical: numeric("combine_vertical"),
  combineShuttle: numeric("combine_shuttle"),
  combineBench: text("combine_bench"),
  combineBroadJump: numeric("combine_broad_jump"),
  combineThreeCone: numeric("combine_three_cone"),
  handSize: numeric("hand_size"),
  armLength: numeric("arm_length"),
  wingspan: numeric("wingspan"),
  pffRank: integer("pff_rank"),
  pffGrade2025: numeric("pff_grade_2025"),
  pffGrade2024: numeric("pff_grade_2024"),
  pffGrade2023: numeric("pff_grade_2023"),
  pffWaa2025: numeric("pff_waa_2025"),
  pffWaa2024: numeric("pff_waa_2024"),
  pffSnaps2025: integer("pff_snaps_2025"),
  dolittleScore: numeric("dolittle_score"),
  ...
  dolittleRecPg: numeric("dolittle_rec_pg"),
  nflTeam: text("nfl_team"),
  nflPick: integer("nfl_pick"),
  schemeFitScore: numeric("scheme_fit_score"),
  targetCompetitionScore: numeric("target_competition_score"),
  qbQualityScore: numeric("qb_quality_score"),
